...
<div class="container mt-3">
  ...
  <div class="form-group row">
    <label for="Jenis_Pinus" class="col-4 col-form-label">K / Jumlah Kluster</label> 
    <div class="col-8">
...
if (isset($_POST['submit'])) {
  ...
  $sql="INSERT INTO `datauji`(`Lingkar_Batang_m`, `Tinggi_m`, `K`) VALUES ('".$Lingkar_Batang_m."','".$Tinggi_m."','".$K."')";
