...
<div class="container mt-3">
  ...
  <div class="form-group row">
    <label for="Lingkar_Batang_m" class="col-4 col-form-label">Lingkar Batang (m)</label> 
    <div class="col-8">
      <input id="Lingkar_Batang_m" name="Lingkar_Batang_m" type="text" class="form-control" required="required" value="<?php echo $r1['Lingkar_Batang_m'];?>">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="Tinggi_m" name="Tinggi_m" type="text" class="form-control" required="required" value="<?php echo $r1['Tinggi_m'];?>">
    </div>
  </div>
  <div class="form-group row">
...
if (isset($_POST['submit'])) {
  ...
  $sql="UPDATE `datatraining` SET `Lingkar_Batang_m`='".$Lingkar_Batang_m."',`Tinggi_m`='".$Tinggi_m."',`Jenis_Pinus`='".$Jenis_Pinus."' WHERE `IdData`='".$IdData."'";
  $q=mysqli_query($koneksi,$sql);
  if ($q) {
    echo '<div class="alert alert-success alert-dismissible">
  <button type="button" class="btn-close" data-bs-dismiss="alert" onclick="window.location.href=\'input_data_training.php\';"></button>
